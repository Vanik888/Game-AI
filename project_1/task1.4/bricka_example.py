...
class Bricka:
    ...
    def create_bricks(self):
        ...
        for i in range(7):
            ...
            for j in range(8):
                self.bricks.append(
                    pygame.Rect(x_ofs, y_ofs, BRICK_WIDTH, BRICK_HEIGHT))
    ...
    def check_input(self):
        ...
        if keys[pygame.K_SPACE] and self.state == STATE_BALL_IN_PADDLE:
            ...
            self.state = STATE_PLAYING
                ...
                self.state == STATE_GAME_OVER or self.state == STATE_WON):
            self.init_game()
    ...
    def move_ball(self):
        ...
        # moving paddle according to the ball.left position.
        self.paddle.left = self.ball.left
